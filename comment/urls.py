...
from comment.views import commentGetAPI, commentCreateAPI, getAllCommentsAPI, likeCommentAPI
...
urlpatterns = [
    ...
    path('api/comment/<int:comment_id>/like', likeCommentAPI.as_view(), name="like_comment")
]